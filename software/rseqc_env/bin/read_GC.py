...
"""Calculate the GC-content distribution of aligned reads."""
...
DESCRIPTION = (
    "Calculate the GC-content distribution of aligned reads that satisfy "
    "the requested mapping-quality threshold."
)

EPILOG = """
Example
-------
read_GC.py -i sample.bam -o sample -q 30
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--skip-plot",
        action="store_true",
        help="Generate GC-profile data but do not execute the R plotting script.",
    )
    parser.add_argument(
        "--rscript",
        default="Rscript",
...
def run_plot_script(
    ...
    script_path = Path(f"{output_prefix}.GC_plot.r")
